...
Rails.application.routes.draw do
  ...
  scope "/organization/:organization_id/" do
    ...
    resources :organization_users, only: [:index, :edit, :update, :destroy], path: "/members", as: :organization_users
  ...
  scope "/users/:user_id" do
    ...
    resources :user_organizations, only: [:index], path: "/organizations"
